...
namespace TiendaUCN.src.Infrastructure.Repositories.Implements
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        {
            return await _context.Categories.AnyAsync(b => b.Name.ToLower() == name.ToLower() && b.IsDeleted == false);
        }
        ...
        {
            return await _context.Categories.AnyAsync(b => b.Id == id && b.IsDeleted == false);
        }

        public async Task<bool> UpdateNameAsync(int id, string name)
        {
            var result = await _context.Categories.Where(b => b.Id == id)
